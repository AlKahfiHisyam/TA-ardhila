	...
	<div class="card-body">
		<form method="POST" action="<?php echo base_url('admin/spt/tambahDataAksi') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pajak_dibayar" class="form-control">
                <?php echo form_error('pajak_dibayar','<div class="text-small text-danger"></div>') ?>
            </div>
            <div class="form-group">
                <label>Penagih</label>
                <select class="form-control" id="nama_pegawai" name="nama_pegawai">
                    <option selected disabled="">Pilih Nama Penagih</option>
